...
def homepage(request):
    ...
    unanswered_tickets_list = [ticket for ticket in user_tickets if ticket not in reviews_tickets_list]
    unanswered_followed_tickets = [ticket for ticket in followed_tickets_list if ticket not in reviews_tickets_list]
    unanswered_followed_tickets.extend(unanswered_tickets_list)
    ...
    filtered_user_tickets = user_tickets.exclude(title__in=unanswered_tickets_list)
    tickets = filtered_user_tickets.annotate(content_type=Value('TICKET', CharField()))
