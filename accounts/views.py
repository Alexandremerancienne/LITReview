...
def homepage(request):
    ...
    unanswered_tickets_list = [ticket for ticket in followed_tickets_list if ticket not in reviews_tickets_list]
    followed_unanswered_tickets = Review.objects.filter(ticket__in=unanswered_tickets_list)
