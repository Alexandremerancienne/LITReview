...
urlpatterns = [
    ...
    path(
         "edit_ticket/<int:id_ticket>/",
         views.edit_ticket,
         name="edit_ticket"
    ),
    path(
         "edit_review/<int:id_review>/",
         views.edit_review,
         name="edit_review"
    ),
